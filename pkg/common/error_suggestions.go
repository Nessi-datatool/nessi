...
type ErrorSuggestion struct {
	ErrorCode    ErrorCode // The error code this suggestion applies to
...
var errorSuggestions = map[ErrorCode][]ErrorSuggestion{}
...
func InitDefaultSuggestions() {
	...
	RegisterErrorSuggestion(ErrorSuggestion{
		ErrorCode:   ErrAuthenticationFailed,
	...
	// Delta Lake errors
	RegisterErrorSuggestion(ErrorSuggestion{
		ErrorCode:   ErrInvalidDeltaTable,
	...
	RegisterErrorSuggestion(ErrorSuggestion{
		ErrorCode:   ErrCorruptedDeltaTable,
	...
	// Databricks errors
	RegisterErrorSuggestion(ErrorSuggestion{
		ErrorCode:   ErrDatabricksAPIError,

...
const (
	...
	ErrViralShareFailed     ErrorCode = "V101" // Error code for share command failures
	ErrViralBadgeFailed     ErrorCode = "V102" // Error code for badge command failures
	ErrViralCommunityFailed ErrorCode = "V103" // Error code for community command failures
	ErrViralPluginNotFound  ErrorCode = "V104" // Error code for plugin not found errors
	ErrViralInvalidInput    ErrorCode = "V105" // Error code for invalid input errors
)
...
var ErrorCodeMap = map[ErrorCode]string{
	...
	ErrViralShareFailed:     "Share command failed",
	ErrViralBadgeFailed:     "Badge command failed",
	ErrViralCommunityFailed: "Community command failed",
	ErrViralPluginNotFound:  "Viral plugin not found",
	ErrViralInvalidInput:    "Invalid input for viral command",
}

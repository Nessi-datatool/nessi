...
sed -i '' -e 's/go 1.23.0/go 1.20/' go.mod 2>/dev/null || sed -i 's/go 1.23.0/go 1.20/' go.mod
...
sed -i '' -e '/toolchain go1.24.3/d' go.mod 2>/dev/null || sed -i '/toolchain go1.24.3/d' go.mod

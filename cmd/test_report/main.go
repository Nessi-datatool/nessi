...
func generateQualityReport(generator *report.ReportGenerator) {
	...
	// Generate report
	outputPath := filepath.Join("reports", "quality_report.html")
	outputFile, err := generator.GenerateReport(data, "quality", report.HTML, outputPath)
	if err != nil {
...
func generateSchemaReport(generator *report.ReportGenerator) {
	...
	// Generate report
	outputPath := filepath.Join("reports", "schema_report.html")
	outputFile, err := generator.GenerateReport(data, "schema", report.HTML, outputPath)
	if err != nil {
...
func generateFreshnessReport(generator *report.ReportGenerator) {
	...
	// Generate report
	outputPath := filepath.Join("reports", "freshness_report.html")
	outputFile, err := generator.GenerateReport(data, "freshness", report.HTML, outputPath)
	if err != nil {
...
func generatePerformanceReport(generator *report.ReportGenerator) {
	...
	// Generate report
	outputPath := filepath.Join("reports", "performance_report.html")
	outputFile, err := generator.GenerateReport(data, "performance", report.HTML, outputPath)
	if err != nil {

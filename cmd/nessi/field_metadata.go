...
// fieldMetadataCmd represents the field-metadata command
var fieldMetadataCmd = &cobra.Command{
	Use:   "field-metadata",
...
// getFieldMetadataCmd represents the get-field-metadata command
var getFieldMetadataCmd = &cobra.Command{
...
// getAllFieldsMetadataCmd represents the get-all-fields-metadata command
var getAllFieldsMetadataCmd = &cobra.Command{
...
// addFieldMetadataCmd represents the add-field-metadata command
var addFieldMetadataCmd = &cobra.Command{
...
// RegisterCommands registers the field-metadata commands with the given root command
func RegisterCommands(root *cobra.Command) {
	// Add field-metadata command to root command
	root.AddCommand(fieldMetadataCmd)
	fieldMetadataCmd.AddCommand(getFieldMetadataCmd)
	fieldMetadataCmd.AddCommand(getAllFieldsMetadataCmd)
	fieldMetadataCmd.AddCommand(addFieldMetadataCmd)

	// Add flags for get commands
	getFieldMetadataCmd.Flags().StringP("format", "f", "text", "Output format (text or json)")
	getAllFieldsMetadataCmd.Flags().StringP("format", "f", "text", "Output format (text or json)")

	// Add flags for add command
	addFieldMetadataCmd.Flags().StringP("description", "d", "", "Field description")
	addFieldMetadataCmd.Flags().StringP("tags", "t", "", "Comma-separated list of tags")
	addFieldMetadataCmd.Flags().StringP("properties", "p", "", "Comma-separated list of key=value pairs")
}

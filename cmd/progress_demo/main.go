...
func main() {
	...
	showTiming := flag.Bool("timing", false, "Show timing information")
	barDemo := flag.Bool("bar", false, "Demo progress bar only")
	spinnerDemo := flag.Bool("spinner", false, "Demo spinner only")
	flag.Parse()
